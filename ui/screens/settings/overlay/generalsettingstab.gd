...
func _ready():
	...
	position_x.set_label("Adjust position (X):")
	...
	position_y.set_label("Adjust position (Y):")
	...
	position_z.set_label("Adjust position (Z):")
	...
	rotation_x.set_slider_range(-15, 15, 0.01)
	...
	rotation_y.set_slider_range(-15, 15, 0.01)
	...
	rotation_z.set_slider_range(-15, 15, 0.01)
	...
	var position_x_hand = preload("res://ui/elements/options/slideroption.tscn").instance()
	get_node(SettingsNode + "RightSettings").add_child(position_x_hand)
	position_x_hand.set_label("Adjust position (X):")
	position_x_hand.set_slider_range(-5, 5, 0.01)
	position_x_hand.set_option_name("position_x_hand")
	position_x_hand.set_value(DefaultSettings.get_default_setting("overlay/position_x_hand"))
	position_x_hand.set_widget_node(self)
	position_x_hand.add_to_group("hand_mode")
	position_x_hand.add_to_group("general_settings")
	...
	position_y_hand.set_label("Adjust position (Y):")
	position_y_hand.set_slider_range(-5, 5, 0.01)
	position_y_hand.set_option_name("position_y_hand")
	position_y_hand.set_value(DefaultSettings.get_default_setting("overlay/position_y_hand"))
	position_y_hand.set_widget_node(self)
	position_y_hand.add_to_group("hand_mode")
	position_y_hand.add_to_group("general_settings")
	...
	position_z_hand.set_label("Adjust position (Z):")
	position_z_hand.set_slider_range(-5, 5, 0.01)
	...
	var rotation_x_hand = preload("res://ui/elements/options/slideroption.tscn").instance()
	get_node(SettingsNode + "RightSettings").add_child(rotation_x_hand)
	rotation_x_hand.set_label("Adjust rotation (X):")
	rotation_x_hand.set_slider_range(-15, 15, 0.01)
	rotation_x_hand.set_option_name("rotation_x_hand")
	rotation_x_hand.set_value(DefaultSettings.get_default_setting("overlay/rotation_x_hand"))
	rotation_x_hand.set_widget_node(self)
	rotation_x_hand.add_to_group("hand_mode")
	rotation_x_hand.add_to_group("general_settings")
		
	var rotation_y_hand = preload("res://ui/elements/options/slideroption.tscn").instance()
	get_node(SettingsNode + "RightSettings").add_child(rotation_y_hand)
	rotation_y_hand.set_label("Adjust rotation (Y):")
	rotation_y_hand.set_slider_range(-15, 15, 0.01)
	rotation_y_hand.set_option_name("rotation_y_hand")
	rotation_y_hand.set_value(DefaultSettings.get_default_setting("overlay/rotation_y_hand"))
	rotation_y_hand.set_widget_node(self)
	rotation_y_hand.add_to_group("hand_mode")
	rotation_y_hand.add_to_group("general_settings")
	
	var rotation_z_hand = preload("res://ui/elements/options/slideroption.tscn").instance()
	get_node(SettingsNode + "RightSettings").add_child(rotation_z_hand)
	rotation_z_hand.set_label("Adjust rotation (Z):")
	rotation_z_hand.set_slider_range(-15, 15, 0.01)
	rotation_z_hand.set_option_name("rotation_z_hand")
	rotation_z_hand.set_value(DefaultSettings.get_default_setting("overlay/rotation_z_hand"))
	rotation_z_hand.set_widget_node(self)
	rotation_z_hand.add_to_group("hand_mode")
	rotation_z_hand.add_to_group("general_settings")
