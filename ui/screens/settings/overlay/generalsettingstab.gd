...
func _ready():
	...
	position_x_hand.set_label("Adjust position (left/right):")
	...
	position_y_hand.set_label("Adjust position (up/down):")
	...
	rotation_x_hand.set_slider_range(-15, 15, 0.1)
	...
	rotation_y_hand.set_slider_range(-15, 15, 0.1)
	...
	rotation_z_hand.set_slider_range(-15, 15, 0.1)
